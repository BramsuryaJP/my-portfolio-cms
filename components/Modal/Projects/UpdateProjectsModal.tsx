...
import { UpdateProjectsModalProps } from '../types'
import { updateProjectsFn } from '@/api/projects'
import { DynamicTextarea } from '@/components/Field/DynamicTextarea'

type UpdateProjectMutationInput = FormData

export default function UpdateProjectsModal({
	isOpen,
	setIsOpen,
	refetch,
	projectId,
	...
	const handleUpdateProject = useMutation({
		mutationFn: (data: UpdateProjectMutationInput) =>
			updateProjectsFn(data, projectId),
		onMutate() {
			setLoading(true)
		},
		onSuccess: (res) => {
	...
	const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
		...
		handleUpdateProject.mutate(formData)
	}
